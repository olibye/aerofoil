...
//!
//! Run with: `cargo run --example subscriber_node_value_access`
//!
...
///
/// Note: We use StreamPeekRef<i64> as the bound because Rc<RefCell<T>> implements
/// StreamPeek for any T: StreamPeekRef. The peek_value() method is then available
/// on the Rc<RefCell<...>> wrapper.
...
fn main() {
    ...
    // Create downstream node with value access
